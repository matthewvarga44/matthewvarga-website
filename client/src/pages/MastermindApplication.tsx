        ...
        <div className="container relative z-10">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="font-heading text-5xl font-extrabold tracking-tight sm:text-6xl leading-tight mb-6">
              Apply to Join <span className="text-secondary">Retire with Rentals</span>
            </h1>
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mb-12 prose prose-lg max-w-none">
              <p className="text-lg text-foreground/90 leading-relaxed mb-6">
                <strong>Retire with Rentals is an exclusive mastermind community for serious real estate investors.</strong> If you're committed to building wealth through rental properties, Airbnb strategies, and alternative income streams, we'd love to learn more about you.
              </p>

              <div className="flex items-start gap-3 mb-8 p-4 bg-secondary/5 rounded-lg">
                <span className="text-2xl flex-shrink-0">📞</span>
                <p className="text-foreground/90 m-0">
                  <strong>After you apply, we'll invite you to a quick Discovery Call</strong> with me. This conversation helps us both make sure Retire with Rentals is the right fit for you.
                </p>
              </div>
              ...
              <ol className="space-y-3 mb-8 list-decimal list-inside">
                <li className="text-foreground/90">
                  <strong>We're selective</strong> – Retire with Rentals is capped at 300 members so we can go deep, not wide. We want to get to know you and make sure you're going to be a valuable member of the community too.
                </li>
                <li className="text-foreground/90">
              ...
              <ul className="space-y-2 mb-8">
                ...
                <li className="text-foreground/90">→ A peek inside the Retire with Rentals community & experience</li>
